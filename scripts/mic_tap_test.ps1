...
.SYNOPSIS
  ...
  each physical mic and see which channel (ch0..ch7) it maps to.

  Channel map (from Src/main.c Deinterleave_Pair):
    ch0/ch1 = SAI1-A (data pin PE6)   slot0/slot1
    ch2/ch3 = SAI1-B (data pin PE3)   slot0/slot1
    ch4/ch5 = SAI2-A (data pin PD11)  slot0/slot1
    ch6/ch7 = SAI2-B (data pin PA0)   slot0/slot1
...
$label = @(
    "ch0 SAI1-A PE6  slot0/L",
    "ch1 SAI1-A PE6  slot1/R",
    "ch2 SAI1-B PE3  slot0/L",
    "ch3 SAI1-B PE3  slot1/R",
    "ch4 SAI2-A PD11 slot0/L",
    "ch5 SAI2-A PD11 slot1/R",
    "ch6 SAI2-B PA0  slot0/L",
    "ch7 SAI2-B PA0  slot1/R"
)
